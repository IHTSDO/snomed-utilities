...
public class SearchParameters {
	...
	public static enum ATTRIBUTE_SEARCH {
	...
	public SearchParameters init(CHARACTERISTIC characteristic, Scanner in) {
		...
		fullyDefinedOnly = response.equals("y") ? true : false;
		...
		descriptionPresent = response.equals("y") ? true : false;
		...
		response = in.nextLine().trim().toLowerCase();
		attributeSearchPresent = response.equals("y") ? true : false;
